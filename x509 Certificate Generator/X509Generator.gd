...
var X509_cert_filename = "X509_Certificate.crt" #name of application.crt
var X509_key_filename = "x509_Key.key" #name of application.key
...
var not_before = "20250203000000"
var not_after  = "20260202235900"
